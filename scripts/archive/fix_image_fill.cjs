...
aboutCode = aboutCode.replace(
    /<img src="\/img\/profile2\.jpg" alt="Jesus David Julio Romero\." style=\{\{ width: "100%", maxWidth: "480px", borderRadius: "12px", border: "1px solid var\(--primary-color\)", boxShadow: "0 0 20px rgba\(57, 255, 20, 0\.3\)" \}\} \/>/,
