                ...
                <div className="about-details">
                    ...
                    <div className="right">
                        ...
                        <p className="scroll-animate">
                            Enfocado en la implementaci�n de l�gica de negocio, automatizaci�n de procesos y trabajo con
                            ...
                            siempre buenas pr�cticas y Clean Architecture.
                            <br/><br/>
                            Complemento mi perfil backend con conocimientos s�lidos en Frontend (React, TypeScript),
                            lo que me permite participar en soluciones web completas de extremo a extremo. Me caracterizo
                            por mi capacidad de adaptaci�n, aprendizaje continuo y trabajo colaborativo en entornos reales.
                        </p>
                    </div>
                </div>
            </div>
