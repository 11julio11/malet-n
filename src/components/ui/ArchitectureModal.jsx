...
const ArchitectureModal = ({ isOpen, onClose }) => {
  ...
  return (
    <dialog open className="arch-modal-overlay" onClick={onClose} style={{ display: 'flex' }}>
      <article
        className="arch-modal-content tilt-card"
      ...
      >
        <header className="terminal-header">
          <nav className="terminal-buttons">
            <button
              className="terminal-btn btn-red"
              onClick={onClose}
        ...
        <section className="arch-modal-body">
          <h2 className="glitch-hover" data-text="Clean Architecture">
            Clean Architecture
          </h2>
          ...
          <figure className="arch-details" style={{ marginBottom: '2rem' }}>
            <div className="code-line">
              ...
              <span>
                <span className="code-keyword">import</span> {'{ CoreBusinessRules }'}{' '}
                <span className="code-keyword">from</span>{' '}
                <span className="code-string">"@domain"</span>;
              </span>
            </div>
            <div className="code-line">
          ...
          <h2 className="glitch-hover" data-text="Domain-Driven Design">
          ...
          <figure className="arch-details" style={{ marginBottom: '2rem' }}>
            ...
            <div className="code-line">
              <span className="line-num">2</span>
              <span>
                <span className="code-keyword">const</span> aggregateRoot ={' '}
                <span className="code-keyword">new</span> Aggregate();
              </span>
            </div>
            <div className="code-line">
              <span className="line-num">3</span>
          ...
          <h2 className="glitch-hover" data-text="Sistemas Core & ERP">
            Sistemas Core & ERP
          </h2>
          <p className="arch-desc">
            &gt; Dise�o para alta transaccionalidad y consistencia (ACID).
          </p>
          <figure className="arch-details">
            ...
            <div className="code-line">
              <span className="line-num">2</span>
              <span style={{ paddingLeft: '20px' }}>
                <span className="code-keyword">await</span> db.transaction(
            ...
            <div className="code-line">
              ...
              <span style={{ paddingLeft: '40px' }}>
                <span className="code-comment">
                  // Bloqueo optimista / pesimista y logs de auditor�a
                </span>
              </span>
            </div>
            <div className="code-line">
