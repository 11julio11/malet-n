    ...
    useEffect(() => {
        ...
        const drawMatrix = () => {
            ...
            for (let i = 0; i < drops.length; i++) {
                ...
                if (rand > 0.95) {
                    ctx.fillStyle = 'rgba(255, 255, 255, 0.8)' // white highlight
                } else if (rand > 0.8) {
                    ctx.fillStyle = 'rgba(108, 99, 255, 0.6)' // purple
                } else {
                    ctx.fillStyle = 'rgba(0, 229, 255, 0.4)' // cyan
                }
        ...
        >
            ...
            <div
                style={{
                    ...
                    width: '100%',
                    height: '100%',
                    background: `radial-gradient(800px circle at ${mousePosition.x + 200}px ${mousePosition.y - 200}px, rgba(108, 99, 255, 0.1), transparent 40%)`,
